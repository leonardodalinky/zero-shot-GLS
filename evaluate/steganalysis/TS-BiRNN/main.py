...
# model
parser.add_argument(
    "-num-layers", type=int, default=2, help="the number of LSTM layers [default:3]"
)
parser.add_argument(
    "-embed-dim", type=int, default=256, help="number of embedding dimension [defualt:128]"
)
parser.add_argument(
    "-hidden-size", type=int, default=100, help="the number of hidden unit [defualt:100]"
)
parser.add_argument(
