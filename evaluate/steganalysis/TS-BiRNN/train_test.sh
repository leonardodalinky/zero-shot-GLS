...
save_dir_zgls="zero-shot-GLS/tmp_saves/TS-BiRNN_40/zgls"
save_ckpt_zgls="zero-shot-GLS/tmp_saves/TS-BiRNN_40/zgls/best_epochs.pt"

gen_path_ADG="zero-shot-GLS/datasets/imdb/ADG/full/imdb_s2.csv"
save_dir_ADG="zero-shot-GLS/tmp_saves/TS-BiRNN_40/ADG"
save_ckpt_ADG="zero-shot-GLS/tmp_saves/TS-BiRNN_40/ADG/best_epochs.pt"

gen_path_NLS="zero-shot-GLS/datasets/imdb/NLS/imdb_s2_b3.csv"
save_dir_NLS="zero-shot-GLS/tmp_saves/TS-BiRNN_40/NLS"
save_ckpt_NLS="zero-shot-GLS/tmp_saves/TS-BiRNN_40/NLS/best_epochs.pt"

gen_path_RNN="zero-shot-GLS/datasets/imdb/RNN/full/imdb_s2_b3.csv"
save_dir_RNN="zero-shot-GLS/tmp_saves/TS-BiRNN_40/RNN"
save_ckpt_RNN="zero-shot-GLS/tmp_saves/TS-BiRNN_40/RNN/best_epochs.pt"

gen_path_SAAC="zero-shot-GLS/datasets/imdb/SAAC/imdb_s2_k50_d1.00.csv"
save_dir_SAAC="zero-shot-GLS/tmp_saves/TS-BiRNN_40/SAAC"
save_ckpt_SAAC="zero-shot-GLS/tmp_saves/TS-BiRNN_40/SAAC/best_epochs.pt"

gen_path_VAE="zero-shot-GLS/datasets/imdb/VAE/full/imdb_s2_b3.csv"
save_dir_VAE="zero-shot-GLS/tmp_saves/TS-BiRNN_40/VAE"
save_ckpt_VAE="zero-shot-GLS/tmp_saves/TS-BiRNN_40/VAE/best_epochs.pt"
